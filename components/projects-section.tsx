  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-[#F8F9FA] to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4">
        ...
        <StaggerList className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch" staggerDelay={0.1} itemDelay={0.1}>
          {t.projects.items.map((project, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col h-full">
              <div className={`h-32 bg-gradient-to-br ${projectGradients[index]} relative overflow-hidden flex-shrink-0`}>
              ...
              <CardContent className="p-6 flex flex-col flex-1 gap-4">
                ...
                <Button variant="ghost" className="w-full group/btn hover:bg-[#0066CC] hover:text-white transition-all duration-300 mt-auto">
