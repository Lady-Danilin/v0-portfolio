...
export const translations = {
  en: {
    ...
    uxui: {
      ...
      process: {
        ...
        steps: [
          ...
          { step: "04", title: "Test", desc: "Validating solutions with real users" },
          { step: "05", title: "Iterate", desc: "Refining based on feedback and data" },
        ],
      },
    },
    projects: {
      ...
      cta: "Interested in working together on your next project?",
      ctaBtn: "Let's Talk About Your Project",
      items: [
        {
          title: "University Digital Communication Strategy",
          description: "Developed and implemented comprehensive digital communication strategies for FCEFyN UNC, focusing on social media planning and institutional communication.",
          tags: ["Digital Strategy", "Social Media", "Education"],
        },
        {
          title: "BIOINGENIERÍA Digital Transformation",
          description: "Led complete digital marketing overhaul including social media diagnostics, Google Ads campaigns, and brand development for a bioengineering equipment distributor.",
          tags: ["Google Ads", "SEO", "Branding"],
        },
        {
          title: "Radio Mitre Digital Content",
          description: "Produced and managed digital content for agricultural journalism program \"Mitre y el Campo\", including social media strategy and guest coordination.",
    ...
    contact: {
      ...
      cardTitle: "Let's Create Something Amazing Together",
      cardDesc: "Whether you need digital marketing strategy, content creation, or UX/UI design, I'm here to help bring your vision to life.",
      fields: {
        name: "Your Name",
      ...
      successMsg: "Your message was sent successfully. I'll get back to you soon!",
      location: "Location",
    },
    footer: {
    ...
    uxui: {
      ...
      process: {
        ...
        steps: [
          ...
          { step: "04", title: "Testear", desc: "Validar soluciones con usuarios reales" },
          { step: "05", title: "Iterar", desc: "Refinar basándose en feedback y datos" },
        ],
      },
    },
    projects: {
      ...
      learnMore: "Ver más",
      cta: "¿Te interesa trabajar juntos en tu próximo proyecto?",
      ctaBtn: "Hablemos de tu proyecto",
      items: [
        {
          title: "Estrategia de comunicación digital universitaria",
          description: "Diseñé e implementé estrategias integrales de comunicación digital para la FCEFyN UNC, con foco en plan de redes y comunicación institucional.",
          tags: ["Estrategia digital", "Redes sociales", "Educación"],
        },
        {
          title: "Transformación digital BIOINGENIERÍA",
          description: "Lideré la renovación completa del marketing digital: diagnóstico de redes, campañas de Google Ads y desarrollo de marca para una distribuidora de equipamiento biomédico.",
          tags: ["Google Ads", "SEO", "Branding"],
        },
        {
          title: "Contenido digital Radio Mitre",
          description: "Producción y gestión de contenido digital para el programa de periodismo agropecuario \"Mitre y el Campo\", incluyendo estrategia en redes y coordinación de invitados.",
          tags: ["Producción radial", "Creación de contenido", "Periodismo"],
        },
      ],
    },
    contact: {
      title: "Contacto",
      subtitle: "Hablemos de oportunidades y colaboraciones",
      infoTitle: "Información de contacto",
      cardTitle: "Creemos algo increíble juntos",
      cardDesc: "Ya sea que necesités estrategia de marketing digital, creación de contenido o diseño UX/UI, estoy acá para dar vida a tu visión.",
      fields: {
        name: "Tu nombre",
      ...
      successMsg: "¡Tu mensaje fue enviado con éxito! Te respondo a la brevedad.",
      location: "Ubicación",
    },
    footer: {
